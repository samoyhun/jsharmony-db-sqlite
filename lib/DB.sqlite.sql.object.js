...
DBObjectSQL.prototype.restructureDrop = function(jsh, module, obj){
  ...
  _.each(['validate_insert','validate_update','insert','update','delete'], function(op){
    if(triggers[op]){
      var triggerName = '';
      if(obj.type=='table'){
        if(op=='validate_insert') triggerName = obj.name+"_before_"+op;
        else if(op=='validate_update') triggerName = obj.name+"_before_"+op;
        else if(op=='insert') triggerName = obj.name+"_after_"+op;
        else if(op=='update') triggerName = obj.name+"_after_"+op;
        else if(op=='delete') triggerName = obj.name+"_before_"+op;
      }
      else if(obj.type=='view'){

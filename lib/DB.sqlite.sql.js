...
DBsql.prototype.getModelMultisel = function (jsh, model, lovfield, allfields, sql_foreignkeyfields, datalockqueries, lov_datalockqueries, param_datalocks) {
  ...
  else if ('code' in lov) { lovsql = 'select ' + jsh.map.code_val + ',' + jsh.map.code_txt + ',' + jsh.map.code_seq + ' from ' + jsh.map.code + '_' + lov['code'] + " where (" + jsh.map.code_end_date + " is null or " + jsh.map.code_end_date + ">datetime('now','localtime'))"; }
  else if ('code_sys' in lov) { lovsql = 'select ' + jsh.map.code_val + ',' + jsh.map.code_txt + ',' + jsh.map.code_seq + ' from ' + jsh.map.code_sys + '_' + lov['code_sys'] + " where (" + jsh.map.code_end_date + " is null or " + jsh.map.code_end_date + ">datetime('now','localtime'))"; }
  else if ('code_app' in lov) { lovsql = 'select ' + jsh.map.code_val + ',' + jsh.map.code_txt + ',' + jsh.map.code_seq + ' from ' + jsh.map.code_app + '_' + lov['code_app'] + " where (" + jsh.map.code_end_date + " is null or " + jsh.map.code_end_date + ">datetime('now','localtime'))"; }
...
DBsql.prototype.getLOV = function (jsh, fname, lov, datalockqueries, param_datalocks, options) {
  ...
  else if ('code' in lov) { sql = 'select ' + jsh.map.code_val + ',' + jsh.map.code_txt + ' from '+(lov.schema?lov.schema+'_':'')+ jsh.map.code + '_' + lov['code'] + " where (" + jsh.map.code_end_date + " is null or " + jsh.map.code_end_date + ">datetime('now','localtime')) order by " + jsh.map.code_seq + ',' + jsh.map.code_txt + ' COLLATE NOCASE'; }
  else if ('code2' in lov) { sql = 'select ' + jsh.map.code_val + '1 as ' + jsh.map.code_parent + ',' + jsh.map.code_val + '2 as ' + jsh.map.code_val + ',' + jsh.map.code_txt + ' from '+(lov.schema?lov.schema+'_':'')+jsh.map.code2 + '_' + lov['code2'] + " where (" + jsh.map.code_end_date + " is null or " + jsh.map.code_end_date + ">datetime('now','localtime')) order by " + jsh.map.code_seq + ',' + jsh.map.code_txt + ' COLLATE NOCASE'; }
  else if ('code_sys' in lov) { sql = 'select ' + jsh.map.code_val + ',' + jsh.map.code_txt + ' from '+(lov.schema?lov.schema+'_':'')+ jsh.map.code_sys + '_' + lov['code_sys'] + " where (" + jsh.map.code_end_date + " is null or " + jsh.map.code_end_date + ">datetime('now','localtime')) order by " + jsh.map.code_seq + ',' + jsh.map.code_txt + ' COLLATE NOCASE'; }
  else if ('code2_sys' in lov) { sql = 'select ' + jsh.map.code_val + '1 as ' + jsh.map.code_parent + ',' + jsh.map.code_val + '2 as ' + jsh.map.code_val + ',' + jsh.map.code_txt + ' from '+(lov.schema?lov.schema+'_':'')+jsh.map.code2_sys + '_' + lov['code2_sys'] + " where (" + jsh.map.code_end_date + " is null or " + jsh.map.code_end_date + ">datetime('now','localtime')) order by " + jsh.map.code_seq + ',' + jsh.map.code_txt + ' COLLATE NOCASE'; }
  else if ('code_app' in lov) { sql = 'select ' + jsh.map.code_val + ',' + jsh.map.code_txt + ' from '+(lov.schema?lov.schema+'_':'')+ jsh.map.code_app + '_' + lov['code_app'] + " where (" + jsh.map.code_end_date + " is null or " + jsh.map.code_end_date + ">datetime('now','localtime')) order by " + jsh.map.code_seq + ',' + jsh.map.code_txt + ' COLLATE NOCASE'; }
  else if ('code2_app' in lov) { sql = 'select ' + jsh.map.code_val + '1 as ' + jsh.map.code_parent + ',' + jsh.map.code_val + '2 as ' + jsh.map.code_val + ',' + jsh.map.code_txt + ' from '+(lov.schema?lov.schema+'_':'')+jsh.map.code2_app + '_' + lov['code2_app'] + " where (" + jsh.map.code_end_date + " is null or " + jsh.map.code_end_date + ">datetime('now','localtime')) order by " + jsh.map.code_seq + ',' + jsh.map.code_txt + ' COLLATE NOCASE'; }
...
DBsql.prototype.getLOVFieldTxt = function (jsh, model, field) {
  ...
  else if ('code' in lov) { rslt = 'select ' + jsh.map.code_txt + ' from '+(lov.schema?lov.schema+'_':'')+ jsh.map.code + '_' + lov['code'] + ' where ' + jsh.map.code_val + '=(' + valsql + ')'; }
  else if ('code2' in lov) {
    if (!parentsql) throw new Error('Parent field not found in LOV.');
    rslt = 'select ' + jsh.map.code_txt + ' from '+(lov.schema?lov.schema+'_':'')+ jsh.map.code2 + '_' + lov['code2'] + ' where ' + jsh.map.code_val + '1=(' + parentsql + ') and ' + jsh.map.code_val + '2=(' + valsql + ')';
  }
  else if ('code_sys' in lov) { rslt = 'select ' + jsh.map.code_txt + ' from '+(lov.schema?lov.schema+'_':'')+ jsh.map.code_sys + '_' + lov['code_sys'] + ' where ' + jsh.map.code_val + '=(' + valsql + ')'; }
  else if ('code2_sys' in lov) {
    if (!parentsql) throw new Error('Parent field not found in LOV.');
    rslt = 'select ' + jsh.map.code_txt + ' from '+(lov.schema?lov.schema+'_':'')+ jsh.map.code2_sys + '_' + lov['code2_sys'] + ' where ' + jsh.map.code_val + '1=(' + parentsql + ') and ' + jsh.map.code_val + '2=(' + valsql + ')';
  }
  else if ('code_app' in lov) { rslt = 'select ' + jsh.map.code_txt + ' from '+(lov.schema?lov.schema+'_':'')+ jsh.map.code_app + '_' + lov['code_app'] + ' where ' + jsh.map.code_val + '=(' + valsql + ')'; }
  else if ('code2_app' in lov) {
    if (!parentsql) throw new Error('Parent field not found in LOV.');
    rslt = 'select ' + jsh.map.code_txt + ' from '+(lov.schema?lov.schema+'_':'')+ jsh.map.code2_app + '_' + lov['code2_app'] + ' where ' + jsh.map.code_val + '1=(' + parentsql + ') and ' + jsh.map.code_val + '2=(' + valsql + ')';
  }

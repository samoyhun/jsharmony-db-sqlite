...
DBsql.prototype.getModelMultisel = function (ent, model, lovfield, allfields, sql_foreignkeyfields, datalockqueries, lov_datalockqueries, param_datalocks) {
  ...
  sql_select_cols += ' ,coalesce(coalesce(cast(codetxt as text), cast(' + ent.map.code_val + ' as text)),cast(' + lovfield.name + ' as text)) ' + ent.map.code_txt;
  ...
  else if ('code_sys' in lov) { lovsql = 'select ' + ent.map.code_val + ',' + ent.map.code_txt + ',' + ent.map.code_seq + ' from ' + ent.map.code_sys + '_' + lov['code_sys'] + " where (CODETDT is null or CODETDT>datetime('now','localtime'))"; }
  else if ('code_app' in lov) { lovsql = 'select ' + ent.map.code_val + ',' + ent.map.code_txt + ',' + ent.map.code_seq + ' from ' + ent.map.code_app + '_' + lov['code_app'] + " where (CODETDT is null or CODETDT>datetime('now','localtime'))"; }
...
DBsql.prototype.getLOV = function (ent, fname, lov, datalockqueries, param_datalocks, options) {
  ...
  else if ('code_sys' in lov) { sql = 'select ' + ent.map.code_val + ',' + ent.map.code_txt + ' from '+(lov.schema?lov.schema+'_':'')+ ent.map.code_sys + '_' + lov['code_sys'] + " where (CODETDT is null or CODETDT>datetime('now','localtime')) order by " + ent.map.code_seq + ',' + ent.map.code_txt; }
  else if ('code2_sys' in lov) { sql = 'select ' + ent.map.code_val + '1 as ' + ent.map.code_parent + ',' + ent.map.code_val + '2 as ' + ent.map.code_val + ',' + ent.map.code_txt + ' from '+(lov.schema?lov.schema+'_':'')+ent.map.code2_sys + '_' + lov['code2_sys'] + " where (CODETDT is null or CODETDT>datetime('now','localtime')) order by " + ent.map.code_seq + ',' + ent.map.code_txt; }
  else if ('code_app' in lov) { sql = 'select ' + ent.map.code_val + ',' + ent.map.code_txt + ' from '+(lov.schema?lov.schema+'_':'')+ ent.map.code_app + '_' + lov['code_app'] + " where (CODETDT is null or CODETDT>datetime('now','localtime')) order by " + ent.map.code_seq + ',' + ent.map.code_txt; }
  else if ('code2_app' in lov) { sql = 'select ' + ent.map.code_val + '1 as ' + ent.map.code_parent + ',' + ent.map.code_val + '2 as ' + ent.map.code_val + ',' + ent.map.code_txt + ' from '+(lov.schema?lov.schema+'_':'')+ent.map.code2_app + '_' + lov['code2_app'] + " where (CODETDT is null or CODETDT>datetime('now','localtime')) order by " + ent.map.code_seq + ',' + ent.map.code_txt; }

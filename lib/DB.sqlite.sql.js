...
DBsql.prototype.upsertModelForm = function (jsh, model, fields, keys, param_datalocks, datalockqueries) {
  var sql = '';
  var sqlwhere = '';

  sql += this.postModelForm(jsh, model, fields, keys, [], [], [], param_datalocks, datalockqueries);
  if(keys) {
